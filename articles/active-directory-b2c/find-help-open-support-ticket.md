...
1. If you have access to multiple tenants, select the **Settings** icon in the top menu to switch to your Azure AD Enterprise tenant from the **Directories + subscriptions** menu.
